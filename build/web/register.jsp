                ...
                <div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
                    <div class="col-first">
                        ...
                        <nav class="d-flex align-items-center">
                            <a href="HomeServlet">Home<span class="lnr lnr-arrow-right"></span></a>
                            <a href="RegisterServlet">Login/Register</a>
                        </nav>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="login_box_img">
                            ...
                            <div class="hover">
                                ...
                                <a class="primary-btn" href="LoginServlet">Login</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="login_form_inner">
                            ...
                            <form class="row login_form" action="RegisterServletl" method="post" id="contactForm" novalidate="novalidate">
